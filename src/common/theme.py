...
class Theme:
    ...
    THEMES = {
        ...
        "Verano": {
            "SQ_LIGHT": (250, 230, 150),
            "SQ_DARK": (210, 100, 30),
            "PIECE_WHITE": (255, 250, 220),
            "PIECE_BLACK": (40, 20, 10),
            "SHADOW_WHITE": (60, 50, 40),
            "SHADOW_BLACK": (180, 160, 130),
        },
        "Otoño": {
            "SQ_LIGHT": (210, 180, 140),
            "SQ_DARK": (120, 75, 40),
            "PIECE_WHITE": (245, 235, 215),
            "PIECE_BLACK": (45, 25, 15),
            "SHADOW_WHITE": (50, 40, 30),
            "SHADOW_BLACK": (170, 150, 130),
        },
        "Invierno": {
            "SQ_LIGHT": (215, 235, 245),
            "SQ_DARK": (65, 105, 130),
            "PIECE_WHITE": (240, 248, 255),
            "PIECE_BLACK": (15, 25, 35),
            "SHADOW_WHITE": (30, 40, 50),
            "SHADOW_BLACK": (140, 160, 180),
        },
        "Primavera": {
            "SQ_LIGHT": (245, 205, 215),
            "SQ_DARK": (105, 165, 120),
            "PIECE_WHITE": (255, 245, 248),
            "PIECE_BLACK": (20, 35, 25),
            "SHADOW_WHITE": (50, 40, 45),
            "SHADOW_BLACK": (160, 180, 165),
        }
    }

    @classmethod
    def apply_design(cls, name: str):
        if name in cls.THEMES:
            d = cls.THEMES[name]
            cls.SQ_LIGHT = d["SQ_LIGHT"]
            cls.SQ_DARK = d["SQ_DARK"]
            cls.PIECE_WHITE = d["PIECE_WHITE"]
            cls.PIECE_BLACK = d["PIECE_BLACK"]
            cls.SHADOW_WHITE = d["SHADOW_WHITE"]
            cls.SHADOW_BLACK = d["SHADOW_BLACK"]
